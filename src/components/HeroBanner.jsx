...
const HeroBanner = () => {
  ...
  return (
    ...
    >
      ...
      <button className={`bg-yellow-400 hover:bg-yellow-300 font-bold py-3 px-8 rounded-full text-lg shadow transition-colors duration-200 ${ecoMode ? "text-white" : "text-blue-900"}`}><a href="./">Shop Now</a></button>
    </div>
  );
};
